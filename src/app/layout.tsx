...
import { Footer, Header, RouteGuard, Providers, SectionSlider } from "@/components";
    ...
    >
      ...
      <Providers>
        ...
        >
          ...
          <Header />
          <Flex zIndex={0} fillWidth padding="l" s={{ paddingX: "m", paddingY: "s" }} horizontal="center" flex={1}>
